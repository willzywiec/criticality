Hot Box 8x4x12 (measured density)
C  Cell cards
1 0 -99 lat=1 u=1 imp:n=1
      fill=0:7 0:3 0:11
       ...
       276    2  277    2  278    2  279    2  $ row j=0 layer k=11
         2  280    2  281    2  282    2  283  $ row j=1 layer k=11
       284    2  285    2  286    2  287    2  $ row j=2 layer k=11
         2  288    2  289    2  290    2  291  $ row j=3 layer k=11
...
C  === fuel universe 276 slot (12, 1, 1) ===
2936 1 -19.076  -10        u=276 imp:n=1  $ right foil
2937 2 -19.3802  -11        u=276 imp:n=1  $ left foil
2938 3 -7.2707  -13        u=276 imp:n=1  $ bottom clad
2939 3 -7.2707  -14        u=276 imp:n=1  $ top clad
2940 0             -15 10 11  u=276 imp:n=1  $ foil-plane void
2941 0             -22 12     u=276 imp:n=1  $ void around clad
2942 4 -2.7338  -20        u=276 imp:n=1  $ 1in graphite
2943 4 -2.7338  -21        u=276 imp:n=1  $ 2in graphite
2944 4 -2.7338  -30        u=276 imp:n=1  $ left rail
2945 4 -2.7338  -31        u=276 imp:n=1  $ right rail
2946 0            -23        u=276 imp:n=1  $ top gap
C  === fuel universe 277 slot (12, 3, 1) ===
2947 1 -16.9804  -10        u=277 imp:n=1  $ right foil
2948 2 -17.9689  -11        u=277 imp:n=1  $ left foil
2949 3 -7.2707  -13        u=277 imp:n=1  $ bottom clad
2950 3 -7.2707  -14        u=277 imp:n=1  $ top clad
2951 0             -15 10 11  u=277 imp:n=1  $ foil-plane void
2952 0             -22 12     u=277 imp:n=1  $ void around clad
2953 4 -2.7338  -20        u=277 imp:n=1  $ 1in graphite
2954 4 -2.7338  -21        u=277 imp:n=1  $ 2in graphite
2955 4 -2.7338  -30        u=277 imp:n=1  $ left rail
2956 4 -2.7338  -31        u=277 imp:n=1  $ right rail
2957 0            -23        u=277 imp:n=1  $ top gap
C  === fuel universe 278 slot (12, 5, 1) ===
2958 1 -19.1977  -10        u=278 imp:n=1  $ right foil
2959 2 -19.2433  -11        u=278 imp:n=1  $ left foil
2960 3 -7.2137  -13        u=278 imp:n=1  $ bottom clad
2961 3 -7.2137  -14        u=278 imp:n=1  $ top clad
2962 0             -15 10 11  u=278 imp:n=1  $ foil-plane void
2963 0             -22 12     u=278 imp:n=1  $ void around clad
2964 4 -2.7338  -20        u=278 imp:n=1  $ 1in graphite
2965 4 -2.7338  -21        u=278 imp:n=1  $ 2in graphite
2966 4 -2.7338  -30        u=278 imp:n=1  $ left rail
2967 4 -2.7338  -31        u=278 imp:n=1  $ right rail
2968 0            -23        u=278 imp:n=1  $ top gap
C  === fuel universe 279 slot (12, 7, 1) ===
2969 1 -18.2274  -10        u=279 imp:n=1  $ right foil
2970 2 -20.2013  -11        u=279 imp:n=1  $ left foil
2971 3 -7.2165  -13        u=279 imp:n=1  $ bottom clad
2972 3 -7.2165  -14        u=279 imp:n=1  $ top clad
2973 0             -15 10 11  u=279 imp:n=1  $ foil-plane void
2974 0             -22 12     u=279 imp:n=1  $ void around clad
2975 4 -2.7338  -20        u=279 imp:n=1  $ 1in graphite
2976 4 -2.7338  -21        u=279 imp:n=1  $ 2in graphite
2977 4 -2.7338  -30        u=279 imp:n=1  $ left rail
2978 4 -2.7338  -31        u=279 imp:n=1  $ right rail
2979 0            -23        u=279 imp:n=1  $ top gap
C  === fuel universe 280 slot (12, 2, 2) ===
2980 1 -18.2579  -10        u=280 imp:n=1  $ right foil
2981 2 -18.3339  -11        u=280 imp:n=1  $ left foil
2982 3 -7.1503  -13        u=280 imp:n=1  $ bottom clad
2983 3 -7.1503  -14        u=280 imp:n=1  $ top clad
2984 0             -15 10 11  u=280 imp:n=1  $ foil-plane void
2985 0             -22 12     u=280 imp:n=1  $ void around clad
2986 4 -2.7338  -20        u=280 imp:n=1  $ 1in graphite
2987 4 -2.7338  -21        u=280 imp:n=1  $ 2in graphite
2988 4 -2.7338  -30        u=280 imp:n=1  $ left rail
2989 4 -2.7338  -31        u=280 imp:n=1  $ right rail
2990 0            -23        u=280 imp:n=1  $ top gap
C  === fuel universe 281 slot (12, 4, 2) ===
2991 1 -18.2426  -10        u=281 imp:n=1  $ right foil
2992 2 -18.3035  -11        u=281 imp:n=1  $ left foil
2993 3 -7.2986  -13        u=281 imp:n=1  $ bottom clad
2994 3 -7.2986  -14        u=281 imp:n=1  $ top clad
2995 0             -15 10 11  u=281 imp:n=1  $ foil-plane void
2996 0             -22 12     u=281 imp:n=1  $ void around clad
2997 4 -2.7338  -20        u=281 imp:n=1  $ 1in graphite
2998 4 -2.7338  -21        u=281 imp:n=1  $ 2in graphite
2999 4 -2.7338  -30        u=281 imp:n=1  $ left rail
3000 4 -2.7338  -31        u=281 imp:n=1  $ right rail
3001 0            -23        u=281 imp:n=1  $ top gap
C  === fuel universe 282 slot (12, 6, 2) ===
3002 1 -17.6648  -10        u=282 imp:n=1  $ right foil
3003 2 -18.1514  -11        u=282 imp:n=1  $ left foil
3004 3 -7.2707  -13        u=282 imp:n=1  $ bottom clad
3005 3 -7.2707  -14        u=282 imp:n=1  $ top clad
3006 0             -15 10 11  u=282 imp:n=1  $ foil-plane void
3007 0             -22 12     u=282 imp:n=1  $ void around clad
3008 4 -2.7338  -20        u=282 imp:n=1  $ 1in graphite
3009 4 -2.7338  -21        u=282 imp:n=1  $ 2in graphite
3010 4 -2.7338  -30        u=282 imp:n=1  $ left rail
3011 4 -2.7338  -31        u=282 imp:n=1  $ right rail
3012 0            -23        u=282 imp:n=1  $ top gap
C  === fuel universe 283 slot (12, 8, 2) ===
3013 1 -18.3187  -10        u=283 imp:n=1  $ right foil
3014 2 -17.5279  -11        u=283 imp:n=1  $ left foil
3015 3 -7.2707  -13        u=283 imp:n=1  $ bottom clad
3016 3 -7.2707  -14        u=283 imp:n=1  $ top clad
3017 0             -15 10 11  u=283 imp:n=1  $ foil-plane void
3018 0             -22 12     u=283 imp:n=1  $ void around clad
3019 4 -2.7338  -20        u=283 imp:n=1  $ 1in graphite
3020 4 -2.7338  -21        u=283 imp:n=1  $ 2in graphite
3021 4 -2.7338  -30        u=283 imp:n=1  $ left rail
3022 4 -2.7338  -31        u=283 imp:n=1  $ right rail
3023 0            -23        u=283 imp:n=1  $ top gap
C  === fuel universe 284 slot (12, 1, 3) ===
3024 1 -19.8668  -10        u=284 imp:n=1  $ right foil
3025 2 -18.8205  -11        u=284 imp:n=1  $ left foil
3026 3 -7.02  -13        u=284 imp:n=1  $ bottom clad
3027 3 -7.02  -14        u=284 imp:n=1  $ top clad
3028 0             -15 10 11  u=284 imp:n=1  $ foil-plane void
3029 0             -22 12     u=284 imp:n=1  $ void around clad
3030 4 -2.7338  -20        u=284 imp:n=1  $ 1in graphite
3031 4 -2.7338  -21        u=284 imp:n=1  $ 2in graphite
3032 4 -2.7338  -30        u=284 imp:n=1  $ left rail
3033 4 -2.7338  -31        u=284 imp:n=1  $ right rail
3034 0            -23        u=284 imp:n=1  $ top gap
C  === fuel universe 285 slot (12, 3, 3) ===
3035 1 -19.2129  -10        u=285 imp:n=1  $ right foil
3036 2 -19.3649  -11        u=285 imp:n=1  $ left foil
3037 3 -7.1827  -13        u=285 imp:n=1  $ bottom clad
3038 3 -7.1827  -14        u=285 imp:n=1  $ top clad
3039 0             -15 10 11  u=285 imp:n=1  $ foil-plane void
3040 0             -22 12     u=285 imp:n=1  $ void around clad
3041 4 -2.7338  -20        u=285 imp:n=1  $ 1in graphite
3042 4 -2.7338  -21        u=285 imp:n=1  $ 2in graphite
3043 4 -2.7338  -30        u=285 imp:n=1  $ left rail
3044 4 -2.7338  -31        u=285 imp:n=1  $ right rail
3045 0            -23        u=285 imp:n=1  $ top gap
C  === fuel universe 286 slot (12, 5, 3) ===
3046 1 -19.2889  -10        u=286 imp:n=1  $ right foil
3047 2 -19.1825  -11        u=286 imp:n=1  $ left foil
3048 3 -7.2707  -13        u=286 imp:n=1  $ bottom clad
3049 3 -7.2707  -14        u=286 imp:n=1  $ top clad
3050 0             -15 10 11  u=286 imp:n=1  $ foil-plane void
3051 0             -22 12     u=286 imp:n=1  $ void around clad
3052 4 -2.7338  -20        u=286 imp:n=1  $ 1in graphite
3053 4 -2.7338  -21        u=286 imp:n=1  $ 2in graphite
3054 4 -2.7338  -30        u=286 imp:n=1  $ left rail
3055 4 -2.7338  -31        u=286 imp:n=1  $ right rail
3056 0            -23        u=286 imp:n=1  $ top gap
C  === fuel universe 287 slot (12, 7, 3) ===
3057 1 -19.1672  -10        u=287 imp:n=1  $ right foil
3058 2 -19.5931  -11        u=287 imp:n=1  $ left foil
3059 3 -7.1413  -13        u=287 imp:n=1  $ bottom clad
3060 3 -7.1413  -14        u=287 imp:n=1  $ top clad
3061 0             -15 10 11  u=287 imp:n=1  $ foil-plane void
3062 0             -22 12     u=287 imp:n=1  $ void around clad
3063 4 -2.7338  -20        u=287 imp:n=1  $ 1in graphite
3064 4 -2.7338  -21        u=287 imp:n=1  $ 2in graphite
3065 4 -2.7338  -30        u=287 imp:n=1  $ left rail
3066 4 -2.7338  -31        u=287 imp:n=1  $ right rail
3067 0            -23        u=287 imp:n=1  $ top gap
C  === fuel universe 288 slot (12, 2, 4) ===
3068 1 -18.2579  -10        u=288 imp:n=1  $ right foil
3069 2 -18.3339  -11        u=288 imp:n=1  $ left foil
3070 3 -7.1503  -13        u=288 imp:n=1  $ bottom clad
3071 3 -7.1503  -14        u=288 imp:n=1  $ top clad
3072 0             -15 10 11  u=288 imp:n=1  $ foil-plane void
3073 0             -22 12     u=288 imp:n=1  $ void around clad
3074 4 -2.7338  -20        u=288 imp:n=1  $ 1in graphite
3075 4 -2.7338  -21        u=288 imp:n=1  $ 2in graphite
3076 4 -2.7338  -30        u=288 imp:n=1  $ left rail
3077 4 -2.7338  -31        u=288 imp:n=1  $ right rail
3078 0            -23        u=288 imp:n=1  $ top gap
C  === fuel universe 289 slot (12, 4, 4) ===
3079 1 -18.2426  -10        u=289 imp:n=1  $ right foil
3080 2 -18.3035  -11        u=289 imp:n=1  $ left foil
3081 3 -7.2986  -13        u=289 imp:n=1  $ bottom clad
3082 3 -7.2986  -14        u=289 imp:n=1  $ top clad
3083 0             -15 10 11  u=289 imp:n=1  $ foil-plane void
3084 0             -22 12     u=289 imp:n=1  $ void around clad
3085 4 -2.7338  -20        u=289 imp:n=1  $ 1in graphite
3086 4 -2.7338  -21        u=289 imp:n=1  $ 2in graphite
3087 4 -2.7338  -30        u=289 imp:n=1  $ left rail
3088 4 -2.7338  -31        u=289 imp:n=1  $ right rail
3089 0            -23        u=289 imp:n=1  $ top gap
C  === fuel universe 290 slot (12, 6, 4) ===
3090 1 -17.6648  -10        u=290 imp:n=1  $ right foil
3091 2 -18.1514  -11        u=290 imp:n=1  $ left foil
3092 3 -7.2707  -13        u=290 imp:n=1  $ bottom clad
3093 3 -7.2707  -14        u=290 imp:n=1  $ top clad
3094 0             -15 10 11  u=290 imp:n=1  $ foil-plane void
3095 0             -22 12     u=290 imp:n=1  $ void around clad
3096 4 -2.7338  -20        u=290 imp:n=1  $ 1in graphite
3097 4 -2.7338  -21        u=290 imp:n=1  $ 2in graphite
3098 4 -2.7338  -30        u=290 imp:n=1  $ left rail
3099 4 -2.7338  -31        u=290 imp:n=1  $ right rail
3100 0            -23        u=290 imp:n=1  $ top gap
C  === fuel universe 291 slot (12, 8, 4) ===
3101 1 -18.3187  -10        u=291 imp:n=1  $ right foil
3102 2 -17.5279  -11        u=291 imp:n=1  $ left foil
3103 3 -7.2707  -13        u=291 imp:n=1  $ bottom clad
3104 3 -7.2707  -14        u=291 imp:n=1  $ top clad
3105 0             -15 10 11  u=291 imp:n=1  $ foil-plane void
3106 0             -22 12     u=291 imp:n=1  $ void around clad
3107 4 -2.7338  -20        u=291 imp:n=1  $ 1in graphite
3108 4 -2.7338  -21        u=291 imp:n=1  $ 2in graphite
3109 4 -2.7338  -30        u=291 imp:n=1  $ left rail
3110 4 -2.7338  -31        u=291 imp:n=1  $ right rail
3111 0            -23        u=291 imp:n=1  $ top gap
...
98 rpp -15.22984 228.44760 -30.45968 213.21776 -2.44348 88.99652  $ lattice container
...
ksrc 24.90343 0.00000 0.00000
     ...
     -5.55625 0.00000 83.82000
     5.55625 0.00000 83.82000
     55.36311 0.00000 83.82000
     66.47561 0.00000 83.82000
     116.28247 0.00000 83.82000
     127.39497 0.00000 83.82000
     177.20183 0.00000 83.82000
     188.31433 0.00000 83.82000
     24.90343 60.91936 83.82000
     36.01593 60.91936 83.82000
     85.82279 60.91936 83.82000
     96.93529 60.91936 83.82000
     146.74215 60.91936 83.82000
     157.85465 60.91936 83.82000
     207.66151 60.91936 83.82000
     218.77401 60.91936 83.82000
     -5.55625 121.83872 83.82000
     5.55625 121.83872 83.82000
     55.36311 121.83872 83.82000
     66.47561 121.83872 83.82000
     116.28247 121.83872 83.82000
     127.39497 121.83872 83.82000
     177.20183 121.83872 83.82000
     188.31433 121.83872 83.82000
     24.90343 182.75808 83.82000
     36.01593 182.75808 83.82000
     85.82279 182.75808 83.82000
     96.93529 182.75808 83.82000
     146.74215 182.75808 83.82000
     157.85465 182.75808 83.82000
     207.66151 182.75808 83.82000
     218.77401 182.75808 83.82000
C  Materials cards
