Hot Box 8x4x2 (nominal density)
C  Cell cards
1 0 -99 lat=1 u=1 imp:n=1
      fill=0:7 0:3 0:1
         2    3    2    3    2    3    2    3  $ row j=0 layer k=0
         3    2    3    2    3    2    3    2  $ row j=1 layer k=0
         2    3    2    3    2    3    2    3  $ row j=2 layer k=0
         3    2    3    2    3    2    3    2  $ row j=3 layer k=0
         3    2    3    2    3    2    3    2  $ row j=0 layer k=1
         2    3    2    3    2    3    2    3  $ row j=1 layer k=1
         3    2    3    2    3    2    3    2  $ row j=2 layer k=1
         2    3    2    3    2    3    2    3  $ row j=3 layer k=1
...
C  === fuel universe 3 (nominal) ===
600 1 -18.5835  -10        u=3 imp:n=1  $ right foil
601 2 -18.5835  -11        u=3 imp:n=1  $ left foil
602 3 -7.2694  -13        u=3 imp:n=1  $ bottom clad
603 3 -7.2694  -14        u=3 imp:n=1  $ top clad
604 0             -15 10 11  u=3 imp:n=1  $ foil-plane void
605 0             -22 12     u=3 imp:n=1  $ void around clad
606 4 -2.7338  -20        u=3 imp:n=1  $ 1in graphite
607 4 -2.7338  -21        u=3 imp:n=1  $ 2in graphite
608 4 -2.7338  -30        u=3 imp:n=1  $ left rail
609 4 -2.7338  -31        u=3 imp:n=1  $ right rail
610 0            -23        u=3 imp:n=1  $ top gap
...
98 rpp -15.22984 228.44760 -30.45968 213.21776 -2.44348 12.79652  $ lattice container
